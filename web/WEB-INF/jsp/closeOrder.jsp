...
<form id="closeOrder" class="closeOrder" action="Controller" method="post">
    ...
    <div><label>Order date:</label>
        <input id="inputOrderDate" class="dates" type="text" readonly>
    </div>
    ...
    <div><label>Return date:</label>
        <input id="inputReturnDate" class="dates" type="text" readonly>
    </div>
    <br><br>
    <p id="penaltyError" class="error"></p>
    <div><label>Penalty, Br:</label>
        <input id="penalty" class="number" name="penalty" type="text" value="0" >
    </div>
    <br><br>
    <div><label>Total cost, Br:</label>
        <input id="totalCost" class="number" name="totalCost" type="text" readonly>
    </div>

    <br><br>
    <input type="submit" class="btnSubmit" name="submit" id="submitButton" value="Close order">
</form>
